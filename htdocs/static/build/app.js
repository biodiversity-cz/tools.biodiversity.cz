...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ dwcInputs)
/* harmony export */ });
function dwcInputs() {
  var selectElement = document.getElementById('exportType');
  var dwcInpoutElements = document.getElementById('dwcInputs');
  if (selectElement) {
...
/* harmony export */ });
function ui() {
  var linkContainer = document.getElementById('specimenLinks');
  var targetContainer = document.getElementById('linksPlot');
